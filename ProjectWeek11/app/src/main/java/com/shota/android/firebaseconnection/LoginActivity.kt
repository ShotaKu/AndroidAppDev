...
class LoginActivity : AppCompatActivity(), LoaderCallbacks<Cursor> {
    ...
    fun afterLoginTask(activity: Activity){
        var intent = Intent(activity.baseContext, MainActivity::class.java)
        activity.startActivity(intent)
    }

    inner class UserLoginTask internal constructor(private val activity: Activity, private val mEmail: String, private val mPassword: String) : AsyncTask<Void, Void, Boolean>() {
